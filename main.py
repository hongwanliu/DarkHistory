...
def evolve(
    ...
    x_arr  = np.array([[xH_init, xHe_init, xHeIII_init]]) #MODIFIED
    ...
    while rs > end_rs:
        ...
        if elec_processes:
            ...
            if (
                ...
                xHeIII_elec_cooling = x_arr[-1, 2] #MODIFIED
            else:
        ...
        init_cond_TLA = np.array(
            [Tm_arr[-1], x_arr[-1,0], x_arr[-1,1], x_arr[-1,2]] #MODIFIED
        )
        ...
        if (
            ...
            xHeIII_to_interp= x_arr[-1,2] #MODIFIED
